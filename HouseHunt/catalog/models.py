...
class Building(models.Model):
    ...
    type_of_building = models.ForeignKey(TypeOfBuilding, on_delete=models.CASCADE, null=False, verbose_name='Тип недвижимости')
    ...
    year_of_construction = models.SmallIntegerField(validators=[MinValueValidator(1900), MaxValueValidator(2024)], null=False)

    def __str__(self):
        return f"{self.title}, {self.type_of_building}, {self.square}, {self.year_of_construction},{self.price}, {self.description[:20]}, {self.image_path}, {self.user_id}"
